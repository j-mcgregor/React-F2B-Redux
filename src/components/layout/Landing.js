...
export default () => {
  return (
    <div className="landing container-fluid p-0 text-center">
      ...
      <Parallax percentage={1} speed={9} className="display-5 text-center p-5">original tutorial by <a href="https://www.traversymedia.com/" target="_blank">Travery Media</a></Parallax>
      <Parallax percentage={2} speed={3} className="display-5 text-right p-5">See my  <a href="https://patchyj.github.io/React-F2B/" target="_blank">React-Context</a> example</Parallax>
      <Parallax percentage={1.3} speed={6} className="display-5 text-left p-5">Or my <a href="https://github.com/patchyj/" target="_blank">Github</a></Parallax>
